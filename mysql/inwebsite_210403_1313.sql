...
--
-- Host: localhost:3306
-- Generation Time: Apr 03, 2021 at 05:12 AM
...
('1ivjh6ongpd7kdto3ug0n1a2n0fuqeeo', NULL, '127.0.0.1', 1617426644, 0x5f5f63695f6c6173745f726567656e65726174657c693a313631373236383633303b),
...
(9, 4, 0, '', 'Web Penjualan / ECommerce', NULL, NULL, 'bi bi-check', NULL),
...
(36, 13, 0, 'aset/img/testimonials/testimonials-5.jpg', 'Website yang di buat sangat sesuai dengan yang saya minta dan juga mengikuti teknologi yang terbaru', 'Gafriel Alfarizhi', NULL, 'bi bi-star-fill', NULL),
(37, 13, 0, 'aset/img/testimonials/testimonials-1.jpg', 'Pengerjaan sangat cepat dan tidak memakan waktu banyak', 'Syafiq Maulana', NULL, 'bi bi-star-fill', NULL),
...
(59, 18, 0, NULL, 'linkedin', '', '\'https://linkedin.com/company/inkomputer\',\'_blank\'', 'bi bi-twitter', NULL),
...
(61, 1, 1, '', 'Telphone', '', '\'tel:085710021257\',\'_blank\'', 'bi bi-telephone', NULL),
...
--
ALTER TABLE `content`
  MODIFY `content_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `subscribe`
  MODIFY `subscribe_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
