...
--
-- Host: localhost:3306
-- Generation Time: Apr 01, 2021 at 12:44 PM
...
('1ivjh6ongpd7kdto3ug0n1a2n0fuqeeo', NULL, '127.0.0.1', 1617280795, 0x5f5f63695f6c6173745f726567656e65726174657c693a313631373236383633303b),
...
INSERT INTO `content` (`content_id`, `content_category`, `content_img`, `content_title`, `content_desc`, `content_icon`, `content_color`) VALUES
(1, 1, 'aset/img/hero-img.png', 'Kami Menawarkan Solusi Modern Untuk Pembuatan Website', 'Hubungi Kami', 'bi bi-arrow-right', NULL),
(2, 2, 'aset/img/values-1.png', 'Tampilan Yang Menarik', 'Website yang kami buat pastinya memiliki tampilan yang menarik.', NULL, NULL),
(3, 2, 'aset/img/values-2.png', 'Responsive', 'Kami membuat website dengan tampilan responsive.', NULL, NULL),
(4, 2, 'aset/img/values-3.png', 'Tidak memakan waktu', 'Kami akan selalu tepat waktu dalam mengerjakan website yang anda pesan.', NULL, NULL),
(5, 3, '', 'Pelanggan Puas', '232', 'bi bi-emoji-smile', 'style=\"color: #4154f1;\"'),
(6, 3, '', 'Projek', '20', 'bi bi-journal-richtext', 'style=\"color: #ee6c20;\"'),
(7, 3, '', 'Jam Pengerjaan', '96', 'bi bi-headset', 'style=\"color: #15be56;\"'),
(8, 3, '', 'Pekerja', '9', 'bi bi-people', 'style=\"color: #bb0852;\"'),
(9, 4, '', 'Web Penjualan / ECommerce', NULL, 'bi bi-check', NULL),
(10, 4, '', 'Web Sistem Kantor', NULL, 'bi bi-check', NULL),
(11, 4, '', 'Web Inventaris', NULL, 'bi bi-check', NULL),
(12, 4, '', 'Web Profil Perusahaan', NULL, 'bi bi-check', NULL),
(13, 4, '', 'Web Portal Berita', NULL, 'bi bi-check', NULL),
(14, 4, '', 'Blog', NULL, 'bi bi-check', NULL),
(15, 5, 'aset/img/features.png', NULL, NULL, NULL, NULL),
(19, 6, NULL, 'Visi', 'active', NULL, NULL),
(20, 6, '', 'Misi', NULL, NULL, NULL),
(21, 7, NULL, 'Visi', 'Menjadi perusahaan Teknologi Informasi dan Komunikasi profesional yang memberikan solusi serta layanan terintegritasi dan mengikuti perkembangan dunia teknologi Informasi.', NULL, NULL),
(22, 8, NULL, 'Misi 1', 'Memberikan solusi dan layanan terpadu dalam setiap layanan Teknologi Informasi yang kami berikan.', 'bi bi-check2', NULL),
(23, 9, 'aset/img/features-2.png', NULL, NULL, NULL, NULL),
(24, 10, 'aset/img/features-3.png', NULL, NULL, NULL, NULL),
(25, 11, NULL, 'Berpengalaman', 'Kami telah berpengalan dalam pembuatan web.', 'ri-line-chart-line', NULL),
(26, 11, NULL, 'Tim yang Handal', 'Memiliki team yang handal dan telah banyak menciptakan web dan aplikasi.', 'ri-stack-line', NULL),
(27, 11, NULL, 'Berkualitas', 'Dalam mengembangkan system aplikasi kami senantiasa mengedepankan kualitas. ', 'ri-brush-4-line', NULL),
(28, 11, NULL, 'Berinovasi', 'Membuat aplikasi dan menerapkan teknologi terkini serta memberikan solusi terbaik dari setiap ide dan usulan dari Anda. ', 'ri-magic-line', NULL),
(29, 11, NULL, 'Harga Kompetitif', 'Kami memberikan penawaran harga yang flexible dan negotable', 'ri-command-line', NULL),
(30, 11, NULL, 'Customize web / Aplikasi', 'Desain dan rancangan aplikasi akan mengikuti kebutuhan dan selera Anda ', 'ri-radar-line', NULL),
(31, 12, NULL, 'Perbedaan Domain dan Hosting?', 'Sebagai dua hal yang paling esensial dalam suatu website,', NULL, NULL),
(32, 12, NULL, 'Apakah Website yang di buat responsive?', 'Pastinya website yang kami kerjakan responsive.', NULL, NULL),
(33, 13, 'aset/img/testimonials/testimonials-2.jpg', 'Sistem webnya terintegritasi dengan sangat baik', 'Rixy Midya', 'bi bi-star-fill', NULL),
(34, 13, 'aset/img/testimonials/testimonials-3.jpg', 'Tampilan Desktop, Tablet dan mobiile sangat bagusdan tidak berantakan', 'Ervin Maulida', 'bi bi-star-fill', NULL),
(35, 13, 'aset/img/testimonials/testimonials-4.jpg', 'Harganya sangat terjangkau untuk pembuatan website yang sangat bagus', 'Hokky Kurniawan', 'bi bi-star-fill', NULL),
(36, 13, 'aset/img/testimonials/testimonials-5.jpg', 'Website yang di buat sangat sesuai dengan yang saya minta dan juga mengikuti teknologi yang terbaru', 'Gafriel Alfarizhi', 'bi bi-star-fill', NULL),
(37, 13, 'aset/img/testimonials/testimonials-1.jpg', 'Pengerjaan sangat cepat dan tidak memakan waktu banyak', 'Syafiq Maulana', 'bi bi-star-fill', NULL),
(42, 8, NULL, 'Misi 2', 'Memberikan Produk dan Layanan terpadu dalam setiap layanan purna jual ke semua pelanggan.', 'bi bi-check2', NULL),
...
(44, 16, NULL, 'IT Design', 'Kami menyediakan design yang responsive dan fungsional untuk perusahaan dan bisnis anda.', 'ri-discuss-line icon', 'blue'),
(45, 16, NULL, 'IT Management', 'Memungkinkan untuk secara bersamaan mengelola dan mengubah informasi dari satu server ke server lainnya.', 'ri-discuss-line icon', 'orange'),
(46, 16, NULL, 'Data Security', 'backup database Anda, simpan di tempat yang aman dan terlindungi dengan tetap menjaga aksesibilitasnya.', 'ri-discuss-line icon', 'green'),
(47, 16, NULL, 'Infrastructure Plan', 'BOSWEB memperhitungkan semua kondisi dan anggaran yang dibutuhkan untuk membangun rencana infrastruktur.', 'ri-discuss-line icon', 'red'),
(48, 16, NULL, 'Firewall Advancement', 'Meningkatkan kekuatan dan keamanan firewall untuk melindungi data online dari sumber berbahaya.', 'ri-discuss-line icon', 'purple'),
(49, 16, NULL, 'Desktop Computing', 'Pemrograman ditangani oleh spesialis kami yang berpengalaman dan profesional dalam manajemen TI.', 'ri-discuss-line icon', 'pink'),
(50, 12, NULL, 'berapa lama waktu pengerjaan website?', 'untuk waktu pengerjaan setiap website pasti berbeda, tergantung jenis website yang ingin di buat.', NULL, NULL),
(51, 12, NULL, 'Estimasi Harga untuk satu website', 'Harga untuk pembuatan website beragam, tergantung website yang ingin anda buat.', NULL, NULL),
(52, 17, NULL, 'Alamat', '<p>Balikpapan Regency<br>Cluster de Castarica<br>Blok JE9 no</p>', 'bi bi-geo-alt', NULL),
(53, 17, NULL, 'Telpon / WA', '                                <p>+62 811 590 890</p>', 'bi bi-telephone', NULL),
(54, 17, NULL, 'Email', '<p>office@inkomputer.id</p>', 'bi bi-envelope', NULL),
(55, 17, NULL, 'Jam Kerja', '<p>\r\n                                    Senin - Jumat<br>9:00 - 17:00\r\n                                    <br>\r\n                                    Sabtu<br>9:00 - 15:00\r\n                                </p>', 'bi bi-clock', NULL),
(56, 18, NULL, 'twitter', '\'https://twitter.com/inkomputer\',\'_blank\'', 'bi bi-twitter', NULL),
(57, 18, NULL, 'facebook', '\'https://fb.com/inkomputer.id\',\'_blank\'', 'bi bi-facebook', NULL),
(58, 18, NULL, 'instagram', '\'https://instagram.com/inkomputer\',\'_blank\'', 'bi bi-instagram bx bxl-instagram', NULL),
(59, 18, NULL, 'linkedin', '\'https://linkedin.com/company/inkomputer\',\'_blank\'', 'bi bi-twitter', NULL);
...
--
ALTER TABLE `content`
  MODIFY `content_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `konsultasi`
  MODIFY `konsultasi_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `subscribe`
  MODIFY `subscribe_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
